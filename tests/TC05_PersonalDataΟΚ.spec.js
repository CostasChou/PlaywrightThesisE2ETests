...
import {StudentWebpage} from '../webpages/StudentWebpage';
...
test('TC05_PersonalDataΟΚ', async ({ page }) => {
    ...
    await homeWebPageObj.clickStudentDataOfCentralMenu();
    
    //Creation of an object of StudentWebpage
    const studentWebpage = new StudentWebpage(page);
    //Perform asertions
    await studentWebpage.isStudentDataTabDisplayed();
    await studentWebpage.areStudentDataTabDetailsDisplayed();
    await studentWebpage.isPersonalDataTabDisplayed();
    //Perform click action
    await studentWebpage.clickOnPersonalDataTabOfStudent();
    //Perform assertion
    await studentWebpage.arePersonalDataTabDetailsDisplayed();
