...
test('TC10_LogInWithoutEnteringUsernameΚΟ', async ({ page }) => {
    //Creation of an object of LogInWebpage
    const logInWebpage =  new LogInWebpage(page);
    //Visist webpage
    logInWebpage.goToLogInWebpage();
    //Perform Log In action with NO USERNAME
    logInWebpage.logIn(fixtures.emptyString, fixtures.password);
    ...
    const isTextPresent = pageTextContent.includes('Username is a required field.');
